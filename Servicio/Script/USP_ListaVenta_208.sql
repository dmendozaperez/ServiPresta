...
BEGIN
	...
	Set	@entidad = (Select dbo.UFN_Obtiene_DatosGenerales('pref_tda')) + (Select dbo.UFN_Obtiene_DatosGenerales('cod_tienda'));	-- '50005'
	Set	@secci	 = (Select dbo.UFN_Obtiene_DatosGenerales('cod_secci'));	-- 'C'
	Set	@almacen = (Select dbo.UFN_Obtiene_DatosGenerales('alma_stk'));	-- 'C'
